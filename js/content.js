var code = (function()
{
	...
	{
		if(document.querySelector("._1impv5u4"))
		{
			var dload = document.createElement("a");
			dload.innerText = "Download";
			dload.setAttribute("class", "_1impv5u4");
			dload.setAttribute("role", "button");
			dload.setAttribute("href", "javascript:void(0)");
			dload.setAttribute('id', "download-KhanAcademy-Project-button");

			document.querySelector("._7z5jsor").appendChild(document.createElement("span").appendChild(dload));
			...
			window.setTimeout(embedDownloadButton, 2000);
		}
	}
